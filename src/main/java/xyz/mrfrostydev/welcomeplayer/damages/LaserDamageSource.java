...
public class LaserDamageSource extends DamageSource {
    public LaserDamageSource(Holder<DamageType> type, @Nullable Entity entity) {
        super(type, entity);
    }

    @Override
    public @NotNull Component getLocalizedDeathMessage(LivingEntity victim){
        return Component.translatable("death.welcomeplayer.damage.laser", victim.getDisplayName());
    }
}
