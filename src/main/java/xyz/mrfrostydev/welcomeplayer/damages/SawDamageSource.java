...
public class SawDamageSource extends DamageSource {
    public SawDamageSource(Holder<DamageType> type, @Nullable Entity entity) {
        super(type, entity);
    }

    @Override
    public @NotNull Component getLocalizedDeathMessage(LivingEntity victim){
        return Component.translatable("death.welcomeplayer.damage.saw", victim.getDisplayName());
    }
}
