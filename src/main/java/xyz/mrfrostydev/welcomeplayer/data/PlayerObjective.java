...
public record PlayerObjective(String id, AudiencePhase phase, List<Component> dialog) {
    public static final PlayerObjective NOTHING = new PlayerObjective("nothing", AudiencePhase.NEUTRAL, List.of(Component.literal("nothing new")));
    ...
    public static PlayerObjective create(String v, AudiencePhase phase, List<Component> dialog){
        return new PlayerObjective(v, phase, dialog);
    }
